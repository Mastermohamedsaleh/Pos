<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <li><a href="{{URL('/')}}"><i class="fa fa-th"></i><span>{{trans('site.dashboard')}}</span></a></li>
           ...
           <li><a href="{{ URL('setting'  , auth()->user()->id ) }}"><i class="fa fa-th"></i><span>{{trans('site.setting')}}</span></a></li>         
